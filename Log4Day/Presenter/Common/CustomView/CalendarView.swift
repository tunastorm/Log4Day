            ...
            ForEach(-firstWeekday ..< daysInMonth + visibleDaysOfNextMonth, id: \.self) { index in
                Group {
                    if index > -1 && index < daysInMonth {
                        ...
                        CellView(isShownSheet: $isShownSheet, day: day, clicked: clicked, isToday: isToday)
                        ...
                        CellView(isShownSheet: $isShownSheet, day: day, isCurrentMonthDay: false)
                    }
                }
                .onTapGesture {
...
private struct CellView: View {
    ...
    @ObservedResults(Log.self) var logList
    @Binding private var isShownSheet: Bool
    ...
    fileprivate init(
        isShownSheet: Binding<Bool>,
        day: Int,
        clicked: Bool = false,
        isToday: Bool = false,
        isCurrentMonthDay: Bool = true
    ) {
        self._isShownSheet = isShownSheet
        self.day = day
    ...
    private func cellGraphic() -> some View {
        VStack {
            Circle()
